...
"""Generic CHI policy permits normal HNF allocation for NIC reads."""
...
def check(system):
    ...
    assert sum(tx_fills) == 1, tx_fills
    assert sum(tx_accesses) == 1, tx_accesses
    print("Normal generic NIC-read allocation and data checks passed")
